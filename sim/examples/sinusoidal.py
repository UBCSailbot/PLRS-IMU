...
from plrs_sim import EkfConfig, GnssNoiseModel, ImuNoiseModel, Sinusoidal
from plrs_sim.plot import plot_heading
from plrs_sim.runner import run
from plrs_sim.source import SimulatedSource

src = SimulatedSource(
    trajectory=Sinusoidal(amplitude_deg=45.0, period_s=20.0),
...
plot_heading(run(src, cfg), title="Sinusoidal heading, A=45 deg, T=20 s")
